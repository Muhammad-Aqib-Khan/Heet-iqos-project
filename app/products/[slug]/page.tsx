...
import { useCart } from "@/app/CartContext/cartcontext"; // adjust path
  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4 text-sm sm:text-base">
          ...
          <ul className="text-gray-600 list-disc pl-5 space-y-1">
            ...
            {/* Add more attributes if present */}
          </ul>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2">
                <button onClick={() => setQuantity(Math.max(1, quantity - 1))}
                  className="border px-2 py-1 rounded text-sm hover:bg-gray-100">-</button>
          ...
          <div className="mt-6 space-y-2 text-gray-500 text-sm">
            ...
            <p>💳 Payment Options: Google Pay | Apple Pay | COD</p>
      ...
      <div className="mt-10 p-6 border rounded-lg bg-white shadow-md space-y-6">
        ...
        <p className="text-gray-700">{product.description}</p>
        {/* You can add more descriptive paragraphs or spec list here */}
      </div>
    </div>
  );
}
