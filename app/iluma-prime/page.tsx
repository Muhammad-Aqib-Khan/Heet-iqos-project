...
export default function IlumaPrimePage() {
  // Filter products for ILUMA Prime
  const ilumaPrimeProducts = products.filter(product => 
    product.title.toLowerCase().includes("iluma prime")
  );
    ...
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-white/90 mb-8 leading-relaxed">
                Experience the pinnacle of heated tobacco technology with IQOS ILUMA Prime. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              IQOS ILUMA Prime features the world's first induction heating system for heated tobacco, 
      ...
      <div className="py-16 bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              ILUMA Prime Collection
            </h2>
            <p className="text-lg text-gray-600">
              Choose from our exclusive range of ILUMA Prime devices in premium colors and finishes.
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {ilumaPrimeProducts.map((product) => (
              <ProductCard
                key={product.slug}
                slug={product.slug}
                image={product.image}
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Express your style with our carefully curated color palette, each featuring premium finishes.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="aspect-square bg-gradient-to-br from-gray-900 to-black p-8">
                <img src="/iluma/BlackDevice.png" alt="Obsidian Black" className="w-full h-full object-contain" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Obsidian Black</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Sophisticated and timeless, perfect for the modern professional.
                </p>
                <span className="text-2xl font-bold text-red-600">AED 439</span>
              </div>
            </div>
            
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="aspect-square bg-gradient-to-br from-yellow-100 to-yellow-200 p-8">
                <img src="/iluma/khaki.png" alt="Gold Khaki" className="w-full h-full object-contain" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Gold Khaki</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Warm and luxurious, combining elegance with contemporary style.
                </p>
                <span className="text-2xl font-bold text-red-600">AED 439</span>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="aspect-square bg-gradient-to-br from-green-100 to-green-200 p-8">
                <img src="/iluma/GreenDevice.png" alt="Jade Green" className="w-full h-full object-contain" />
              </div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Jade Green</h3>
                <p className="text-gray-600 text-sm mb-4">
                  Bold and distinctive, for those who dare to stand out.
                </p>
                <span className="text-2xl font-bold text-red-600">AED 439</span>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto">
              IQOS ILUMA Prime works exclusively with TEREA tobacco sticks, 
              featuring the innovative SMARTCORE technology for the ultimate heated tobacco experience.
            </p>
          </div>
          
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <img src="/kazakhstan/amber.webp" alt="TEREA Amber" className="w-20 h-20 mx-auto rounded-lg mb-3" />
              <p className="text-sm text-gray-300">TEREA Amber</p>
            </div>
            <div className="text-center">
              <img src="/kazakhstan/silver.webp" alt="TEREA Silver" className="w-20 h-20 mx-auto rounded-lg mb-3" />
              <p className="text-sm text-gray-300">TEREA Silver</p>
            </div>
            <div className="text-center">
              <img src="/Jpan/OasisPearl.jpg" alt="TEREA Oasis Pearl" className="w-20 h-20 mx-auto rounded-lg mb-3" />
              <p className="text-sm text-gray-300">TEREA Oasis Pearl</p>
            </div>
            <div className="text-center">
              <img src="/indonesia/apricity-indonesia.webp" alt="TEREA Apricity" className="w-20 h-20 mx-auto rounded-lg mb-3" />
      ...
      <div className="bg-gradient-to-r from-yellow-400 to-orange-400 text-black py-12">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl mb-8">
            Discover why IQOS ILUMA Prime is the ultimate choice for discerning tobacco enthusiasts 
