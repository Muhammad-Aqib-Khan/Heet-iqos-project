            ...
            <div className="bg-gray-200 mx-5 rounded-lg">
                <div className="bg-gray-100 px-4 py-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10 px-4 max-w-[1300px] mx-auto">
                        ...
                        <ProductCard slug="terea-berrine-edition" image="/indonesia/berrie.png" brand="Terea Berrine Edition Indonesia" flavour="Terea Berrine Edition" price={125} cutPrice={500} basePath="/products" />
